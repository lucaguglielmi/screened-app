...
import { Workflow, Coins, MailWarning, ShieldCheck } from 'lucide-react';
          ...
          <section className="space-y-4 pt-4">
            <div className="border-b border-zinc-800 pb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Standard 2-stage interaction pattern required for all current and future
                  generative tools.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-2 text-xs text-zinc-300">
                ...
                <div className="p-2.5 rounded-lg bg-emerald-950/40 border border-emerald-500/40 space-y-1">
                  ...
                  <p className="text-[11px] text-zinc-300">
                    Gathers parameters, doc uploads, sliders.
                  </p>
                </div>
                <div className="p-2.5 rounded-lg bg-blue-950/40 border border-blue-500/40 space-y-1">
                  ...
                  <p className="text-[11px] text-zinc-300">
                    Summary card with edit & launch trigger.
                  </p>
                </div>
            ...
            <div className="flex items-center gap-1 bg-midnight p-1 rounded-xl overflow-x-auto">
              ...
              <button
                onClick={() => {
                  soundEffects.playClick();
                  setActiveToolSubtab('INVITATION');
                }}
                className={`px-2.5 py-1 rounded-lg text-xs font-mono transition-colors ${
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <button
                          ...
                          className="group flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-darkroom-border hover:bg-midnight-royal border border-midnight-violet hover:border-tool-ocean text-xs font-medium text-slate-200 hover:text-white transition-all shadow-sm cursor-pointer"
                        >
            ...
            <section className="space-y-4 pt-4">
              <div className="border-b border-zinc-800 pb-3 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-400">
                    How user inputs flow through Gemini 2.5 Pro Function Calling to Parallel Search.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                <div className="p-4 rounded-xl bg-card space-y-2">
                  ...
                  <p className="text-zinc-300">
                    Triggered on queries about festival legitimacy, fees, venues, or scam checks.
                    Mounts <code className="text-emerald-300">FestivalIntakeCard</code>, collects
                    city and interaction context, then launches parallel research across 3 domains.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-card space-y-2">
                  ...
                  <p className="text-zinc-300">
                    Triggered on grants, funding, or subsidies. Mounts{' '}
                    <code className="text-blue-300">GrantIntakeCard</code> with budget and funding
                    sliders, stage selectors, and PDF deck drop zone to match BFI and international
                    public funds.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-card space-y-2">
                  ...
                  <p className="text-zinc-300">
                    Triggered when user pastes an email or mentions unsolicited invites. Mounts{' '}
                    <code className="text-rose-300">InvitationEmailCard</code> to scan sender
                    domains, waiver traps, and trophy upsells.
                  </p>
                </div>
              </div>
            </section>
          ...
          <section className="space-y-4 pt-4">
            <div className="border-b border-zinc-800 pb-3 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  User prompts, assistant responses, and token streaming.
                </p>
              </div>
              <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-400">
                ChatBubble.tsx
          ...
          <section className="space-y-4 pt-4">
            <div className="border-b border-zinc-800 pb-3 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Pulsing agent reasoning pills and status meters.
                </p>
              </div>
              <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-400">
          ...
          <section className="space-y-4 pt-4">
            <div className="border-b border-zinc-800 pb-3 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Multi-modal prompt input and one-click action pills.
                </p>
              </div>
              <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-400">
                ChatPromptBar.tsx
              ...
              <div>
                ...
                <ChatPromptBar
                  onSendMessage={(text, fileName) =>
                    addLog(
                      `[Submit] Sent: "${text.slice(0, 40)}..." (Attached: ${fileName || 'None'})`,
                    )
                  }
                  isLoading={false}
                />
