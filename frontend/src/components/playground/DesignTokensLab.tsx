            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-2 px-3 rounded-xl bg-darkroom-card hover:bg-paper-border hover:bg-darkroom-border border border-darkroom-border text-xs font-mono flex items-center justify-center gap-2 text-slate-300 transition-colors cursor-pointer"
                >
                  {copiedHex === tool.hex ? (
