          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-mono px-2 py-0.5 rounded-full bg-tool-diligence/20 text-tool-diligence border border-tool-diligence/40 font-medium">
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
            {onNavigateToDiligence && (
              <button
                ...
                className="px-4 py-2 rounded-xl bg-darkroom-border hover:bg-darkroom-border text-slate-200 text-xs font-mono border border-darkroom-border transition-all cursor-pointer"
              >
