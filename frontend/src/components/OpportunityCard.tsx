        ...
        return (
          <div className="relative inline-block">
            <span
              ...
              onMouseLeave={() => setShowTooltip(null)}
              className="px-2.5 py-1 rounded-lg text-xs font-mono bg-darkroom-card text-purple-300 font-semibold cursor-help inline-flex items-center gap-1.5 hover:bg-paper-border hover:bg-darkroom-border transition-colors"
            >
        ...
        return (
          <div className="relative inline-block">
            <span
              ...
              onMouseLeave={() => setShowTooltip(null)}
              className="px-2.5 py-1 rounded-lg text-xs font-mono bg-darkroom-card text-yellow-300 font-semibold cursor-help inline-flex items-center gap-1.5 hover:bg-paper-border hover:bg-darkroom-border transition-colors"
            >
        ...
        return (
          <div className="relative inline-block">
            <span
              ...
              onMouseLeave={() => setShowTooltip(null)}
              className="px-2.5 py-1 rounded-lg text-xs font-mono bg-darkroom-card text-blue-300 font-semibold cursor-help inline-flex items-center gap-1.5 hover:bg-paper-border hover:bg-darkroom-border transition-colors"
            >
        ...
        <div className="p-3.5 rounded-2xl bg-darkroom-card flex items-center justify-between text-xs gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-paper-border hover:bg-darkroom-border transition-colors cursor-pointer"
            >
