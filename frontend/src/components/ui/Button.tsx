...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles: Record<ButtonVariant, string> = {
    ...
    secondary:
      'bg-darkroom-card hover:bg-paper-border hover:bg-darkroom-border text-zinc-200 hover:text-white border border-darkroom-border hover:border-midnight-violet',
    outline:
