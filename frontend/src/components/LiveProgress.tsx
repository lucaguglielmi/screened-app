...
const TIMELINE_STEPS: TimelineStep[] = [
  {
    ...
    description:
      'Searches global film festival indices, official domains, and corporate filings to resolve the precise festival identity and eliminate name collisions.',
    details: [
  ...
  },
  {
    ...
    description:
      'Decomposes the confirmed entity into targeted forensic research matrices across Festival Policies, Organizer Credentials, and Participant Footprints.',
    details: [
  ...
  },
  {
    ...
    description:
      'Concurrently executes deep web crawling across venue contracts, press archives, regulatory databases, and filmmaker forums.',
    details: [
  ...
  },
  {
    ...
    description:
      'Parses webpage texts and isolates atomic factual claims, enforcing strict character-exact substring matching to eliminate AI hallucinations.',
    details: [
  ...
  },
  {
    ...
    description:
      'Cross-examines corroborating vs opposing claims, identifying fee disputes, deceptive laurel awards, or fake venue addresses.',
    details: [
  ...
  },
  {
    ...
    description:
      'Assembles the finalized due diligence report with verified claims, dispute matrices, and SHA-256 cryptographic provenance signature.',
    details: [
