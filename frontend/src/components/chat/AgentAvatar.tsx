...
export const AgentAvatar: React.FC<AgentAvatarProps> = ({
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute -inset-2 rounded-full border border-sky-300/40 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-700"
      />
      ...
      <span
        className={`absolute inset-0.5 rounded-full bg-gradient-to-br from-[#38BDF8]/60 to-[#6366F1]/60 blur-xs transition-all duration-700 ${
      ...
      {/* ========================================================================= */}
      <div className={`relative z-10 size-full rounded-full bg-gradient-to-tr from-[#3B82F6] to-[#60A5FA] flex items-center justify-center shadow-lg shadow-blue-500/30 overflow-hidden transition-all duration-700 ${
        ...
        <span className={`absolute bottom-0.5 right-0.5 size-2 rounded-full bg-[#00E5A3] ring-1.5 ring-white/80 shadow-xs shadow-emerald-400 transition-opacity duration-300 ${isActive ? 'opacity-100 animate-pulse' : 'opacity-0'}`} />
      </div>
    </div>
  );
};
