    ...
    >
      <div className="flex items-center justify-between gap-2 border-b border-amber-500/20 pb-2.5 mb-3">
        <div className="flex items-center gap-2.5">
          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-amber-500/20 text-amber-400 text-sm font-bold ring-1 ring-amber-500/40">
            🔍
          </span>
          <div>
            ...
            <p className="text-xs text-zinc-400">Autonomous Multi-Agent Investigation Probe</p>
          </div>
        </div>
        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-amber-400/10 text-amber-300 border border-amber-400/20">
          Ready to Screen
        </span>
      </div>
      ...
      <div className="space-y-3.5 text-sm">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-medium text-zinc-400 mb-1">Target Festival / Organization</label>
            <input
              type="text"
              value={festivalName}
              onChange={(e) => setFestivalName(e.target.value)}
              className="w-full rounded-xl border border-zinc-700/70 bg-zinc-950/80 px-3.5 py-2 text-zinc-100 font-medium focus:border-amber-500 focus:outline-none text-base"
              placeholder="e.g. Raindance Film Festival"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-zinc-400 mb-1">Official Website (Optional)</label>
            <input
              type="text"
              value={optionalUrl}
        ...
        <div className="pt-2 flex items-center justify-end gap-2 border-t border-zinc-800/80">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 px-5 py-2.5 text-sm font-semibold text-zinc-950 shadow-md transition-all hover:brightness-110 active:scale-95 cursor-pointer"
          >
