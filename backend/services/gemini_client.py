...
class GeminiClient:
    ...
    async def extract_claims_from_sources(
        ...
        system_instruction = (
            ...
            "FORENSIC EXTRACTION TARGETS:\n"
            "- Exact submission fee tiers with currency and deadline dates.\n"
            "- Premiere exclusivity rules (World, National, None) and restrictions.\n"
            "- Physical screening venue names, screening rooms, and ticketing box office proof vs. 4-wall hourly rental.\n"
            "- Corporate registration numbers, Companies House/state registrar filings, and registered office addresses.\n"
            "- Jury members, organizers, past award winners, and commercial affiliations.\n\n"
            "EVIDENCE INTEGRITY:\n"
